...
const en = {
  translation: {
    ...
    select_dbml_file: "Select DBML file",
    no_dbml_files_found: "No DBML files found",
    dbml_files_found: "DBML file(s) found",
    enter_file_path_manually: "Enter the file path manually",
    select_repo_and_file: "Please select a repository and a DBML file or path",
    dbml_imported_successfully: "DBML imported successfully",
    error: "Error",
    type_color: "Color",
